...
Overview and my more detailed explanation of functions, queries, and transformation I did in Power BI, SQL and Python can be viewed [here](projects-resources/inflationAT).  
